        ...
        <div class="container" style="background-color:#ffffff;margin-right: 5px;">
          ...
          <div style="background-color:#ffffff">   
              ...
              <div class="form-group">
                ...
                <input type="text" id="result" class="form-control" value="<?php  echo $Eresult ?>"  name="result" readonly> 
              </div>                                                                      
          </div>
          <footer  dir="rtl"  >
              <div class="p-2" >               
               <button class="btn btn-success"  id="submitsave"  name="submitsave">حفظ </button>                                         
               <a class="btn btn-danger"   href="showPage.php?mtype=<?php echo $r=$metype; ?>">تراجع</a>                                                                                                                         
              </div>                                                        
          </footer>
          </form>  
        </div>
